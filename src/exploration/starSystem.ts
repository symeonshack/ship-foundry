...
export const POIS: Record<string, PoiDef> = {
  ...
  nearRock: {
    ...
    color: 0x7a6f60,
    pos: [8, -6],
    composition: { regolith: 0.8, ore: 0.6, ice: 0.4 },
    hazard: { type: null, intensity: 0 },
    blurb: 'A slow tumbling carbonaceous body. Regolith and workable ore near the surface, water ice in the shadowed seams.',
    detail: 'No hazards on record. As friendly as rocks get out here. The ice wants a cryo rig — ice is fuel, once the refinery has its way.',
    terrainSeed: 23,
